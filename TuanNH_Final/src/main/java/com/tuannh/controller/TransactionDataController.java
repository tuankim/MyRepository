...
import com.tuannh.model.RefTransactionTypes;
...
public class TransactionDataController {
    ...
    public ResponseEntity<?> createTransactionData(@RequestBody TransactionData transactionData, UriComponentsBuilder ucBuilder) {
		TransactionData transaction=new TransactionData(new CartCenters(1),new DataTransfers(1),new RefTransactionTypes(1),"20-10-2017",200,"1");
